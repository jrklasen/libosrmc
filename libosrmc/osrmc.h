...
OSRMC_API unsigned
osrmc_nearest_response_count(osrmc_nearest_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_nearest_response_latitude(osrmc_nearest_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_nearest_response_longitude(osrmc_nearest_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_nearest_response_name(osrmc_nearest_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_nearest_response_distance(osrmc_nearest_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_nearest_response_hint(osrmc_nearest_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned long long
osrmc_nearest_response_from_node(osrmc_nearest_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned long long
osrmc_nearest_response_to_node(osrmc_nearest_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_nearest_response_data_version(osrmc_nearest_response_t response, osrmc_error_t* error);
...
OSRMC_API double
osrmc_route_response_distance(osrmc_route_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_route_response_duration(osrmc_route_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_route_response_weight(osrmc_route_response_t response, osrmc_error_t* error);
OSRMC_API const char*
osrmc_route_response_weight_name(osrmc_route_response_t response, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_route_response_alternative_count(osrmc_route_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_route_response_distance_at(osrmc_route_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API double
osrmc_route_response_duration_at(osrmc_route_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API double
osrmc_route_response_weight_at(osrmc_route_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_route_response_geometry_polyline(osrmc_route_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API unsigned
...
osrmc_route_response_geometry_coordinate_longitude(osrmc_route_response_t response,
                                                   ...
                                                   osrmc_error_t* error);
OSRMC_API unsigned
osrmc_route_response_waypoint_count(osrmc_route_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_route_response_waypoint_latitude(osrmc_route_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_route_response_waypoint_longitude(osrmc_route_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_route_response_waypoint_name(osrmc_route_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_route_response_leg_count(osrmc_route_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API double
...
osrmc_route_response_step_intersection_class(osrmc_route_response_t response,
                                             ...
                                             osrmc_error_t* error);
OSRMC_API const char*
osrmc_route_response_data_version(osrmc_route_response_t response, osrmc_error_t* error);
OSRMC_API osrmc_blob_t
...
osrmc_table_response_distance(osrmc_table_response_t response,
                              ...
                              osrmc_error_t* error);
OSRMC_API unsigned
osrmc_table_response_source_count(osrmc_table_response_t response, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_table_response_destination_count(osrmc_table_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_table_response_source_latitude(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_table_response_source_longitude(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_table_response_source_name(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_table_response_destination_latitude(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_table_response_destination_longitude(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_table_response_destination_name(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_table_response_fallback_speed_cells_count(osrmc_table_response_t response, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_table_response_fallback_speed_cell_row(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_table_response_fallback_speed_cell_column(osrmc_table_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_table_response_data_version(osrmc_table_response_t response, osrmc_error_t* error);
OSRMC_API int
...
OSRMC_API unsigned
osrmc_match_response_route_count(osrmc_match_response_t response, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_match_response_tracepoint_count(osrmc_match_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_match_response_route_distance(osrmc_match_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API double
osrmc_match_response_route_duration(osrmc_match_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API double
osrmc_match_response_route_confidence(osrmc_match_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API double
osrmc_match_response_tracepoint_latitude(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_match_response_tracepoint_longitude(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API int
osrmc_match_response_tracepoint_is_null(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_match_response_tracepoint_matchings_index(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API int
osrmc_match_response_tracepoint_waypoint_index(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_match_response_tracepoint_alternatives_count(osrmc_match_response_t response,
                                                   unsigned index,
                                                   osrmc_error_t* error);
OSRMC_API const char*
osrmc_match_response_tracepoint_name(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_match_response_tracepoint_distance(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_match_response_tracepoint_hint(osrmc_match_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_match_response_data_version(osrmc_match_response_t response, osrmc_error_t* error);
OSRMC_API osrmc_blob_t
osrmc_match_response_json(osrmc_match_response_t response, osrmc_error_t* error);
OSRMC_API const char*
osrmc_match_response_geometry_polyline(osrmc_match_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API unsigned
...
osrmc_match_response_geometry_coordinate_longitude(osrmc_match_response_t response,
                                                   ...
                                                   osrmc_error_t* error);
OSRMC_API double
osrmc_match_response_route_weight(osrmc_match_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_match_response_route_weight_name(osrmc_match_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_match_response_alternative_count(osrmc_match_response_t response, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_match_response_leg_count(osrmc_match_response_t response, unsigned route_index, osrmc_error_t* error);
OSRMC_API double
...
OSRMC_API double
osrmc_trip_response_distance(osrmc_trip_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_trip_response_duration(osrmc_trip_response_t response, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_trip_response_waypoint_count(osrmc_trip_response_t response, osrmc_error_t* error);
OSRMC_API double
osrmc_trip_response_waypoint_latitude(osrmc_trip_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_trip_response_waypoint_longitude(osrmc_trip_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_trip_response_waypoint_trips_index(osrmc_trip_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_trip_response_waypoint_waypoint_index(osrmc_trip_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_trip_response_waypoint_name(osrmc_trip_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API double
osrmc_trip_response_waypoint_distance(osrmc_trip_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_trip_response_waypoint_hint(osrmc_trip_response_t response, unsigned index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_trip_response_data_version(osrmc_trip_response_t response, osrmc_error_t* error);
OSRMC_API osrmc_blob_t
osrmc_trip_response_json(osrmc_trip_response_t response, osrmc_error_t* error);
OSRMC_API const char*
osrmc_trip_response_geometry_polyline(osrmc_trip_response_t response, unsigned trip_index, osrmc_error_t* error);
OSRMC_API unsigned
...
osrmc_trip_response_geometry_coordinate_longitude(osrmc_trip_response_t response,
                                                  ...
                                                  osrmc_error_t* error);
OSRMC_API double
osrmc_trip_response_weight(osrmc_trip_response_t response, unsigned trip_index, osrmc_error_t* error);
OSRMC_API const char*
osrmc_trip_response_weight_name(osrmc_trip_response_t response, unsigned trip_index, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_trip_response_alternative_count(osrmc_trip_response_t response, osrmc_error_t* error);
OSRMC_API unsigned
osrmc_trip_response_leg_count(osrmc_trip_response_t response, unsigned trip_index, osrmc_error_t* error);
OSRMC_API double
osrmc_trip_response_leg_distance(osrmc_trip_response_t response,
                                 unsigned trip_index,
                                 unsigned leg_index,
                                 osrmc_error_t* error);
OSRMC_API double
osrmc_trip_response_leg_duration(osrmc_trip_response_t response,
                                 unsigned trip_index,
                                 unsigned leg_index,
                                 osrmc_error_t* error);
OSRMC_API double
